...
ffmpeg -f image2 -stream_loop -1  -i ./544 -framerate 1 -c:v h264 -profile:v main -g 48 -keyint_min 48 -hls_time 4 -hls_pla
ylist_type void -hls_segment_filename 544/%03d.ts 544/544.m3u8
